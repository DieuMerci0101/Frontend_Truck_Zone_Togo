...
export default function ServicesSection() {
  return (
    <section id="services" className="py-8 sm:py-12 bg-white border-t border-amber-500/20 border-b border-amber-500/20">
              ...
              <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <div className="relative h-48 w-full overflow-hidden">
                  <img
                    ...
                    className="object-cover object-center w-full h-full rounded-lg transition-transform duration-300 group-hover:scale-105"
                  />
                </div>
