export const API_URL = process.env.NEXT_PUBLIC_API_URL || "https://truck-zone-togo.onrender.com";
export const WS_URL = process.env.NEXT_PUBLIC_WS_URL || "wss://truck-zone-togo.onrender.com/ws";
