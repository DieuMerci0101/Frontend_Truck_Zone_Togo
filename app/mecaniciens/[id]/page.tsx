    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center">
          <Wrench className="h-14 w-14 sm:h-16 sm:w-16 text-gray-300 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-gray-900 mb-2">
            Mécanicien non trouvé
          </h2>
          <Link href="/mecaniciens">
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                <div className="h-20 w-20 sm:h-24 sm:w-24 rounded-full bg-orange-100 flex items-center justify-center text-orange-700 font-bold text-xl sm:text-2xl flex-shrink-0 overflow-hidden">
            ...
            <CardContent className="space-y-5 sm:space-y-6">
              {mecanicien.bio && (
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600">{mecanicien.bio}</p>
                </div>
              )}
