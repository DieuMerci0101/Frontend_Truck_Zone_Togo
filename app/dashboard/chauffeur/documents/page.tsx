...
const REQUIRED_DOCS = [
  { type: "permis", label: "Permis de conduire", description: "Permis valide pour la catégorie C ou CE" },
...
export default function ChauffeurDocumentsPage() {
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["chauffeur", "documents"] });
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700 mt-1">
                  Pour accéder à toutes les fonctionnalités, veuillez soumettre tous vos documents obligatoires. Un administrateur validera vos documents.
                </p>
              </div>
            </div>
          </CardContent>
