...
import { FileText, CheckCircle, XCircle, Clock, Shield } from "lucide-react";
...
export default function ChauffeurDocumentsPage() {
    ...
    <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700 mt-1">
                  Pour accéder à toutes les fonctionnalités, veuillez soumettre vos 4 documents obligatoires. Un administrateur validera votre dossier.
                </p>
              </div>
            </div>
          </CardContent>
      ...
      {isLoading ? (
        ...
        <DocumentUpload
          ...
          onUploaded={() => queryClient.invalidateQueries({ queryKey: ["chauffeur", "documents"] })}
        />
      )}
      ...
      {documents && documents.length > 0 && (
        <div className="flex justify-end">
          <Button variant="outline" onClick={() => queryClient.invalidateQueries({ queryKey: ["chauffeur", "documents"] })} className="min-h-[44px]">
